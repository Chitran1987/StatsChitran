...
RcppExport SEXP _StatsChitran_Arith_Geom_Prog(SEXP stSEXP, SEXP dSEXP, SEXP rSEXP, SEXP nSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Arith_Geom_Prog(st, d, r, n));
...
RcppExport SEXP _StatsChitran_dot_prd(SEXP XSEXP, SEXP YSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type X(XSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
    rcpp_result_gen = Rcpp::wrap(dot_prd(X, Y));
    return rcpp_result_gen;
END_RCPP
}
// is_prime
...
RcppExport SEXP _StatsChitran_kernel_movavgf(SEXP YSEXP, SEXP bnSEXP, SEXP fnSEXP, SEXP wSEXP, SEXP ordSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(kernel_movavgf(Y, bn, fn, w, ord));
    return rcpp_result_gen;
END_RCPP
}
// line_val
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_StatsChitran_dot_prd", (DL_FUNC) &_StatsChitran_dot_prd, 2},
